...
export const STUDY_PLAN = [
  { day: 1, date: "2026-07-01", phase: "Grundlagen",
    ...
    deck: 0, lesen: 6, hoeren: 0, schreiben: 0, sprechen: 0, grammatik: 0, bausteineStart: 0,
    bausteineFocus: "Verben mit Präposition (sich bewerben um, warten auf)",
    paper: "P5", paperTask: "telc B1a Probe – Leseverstehen Teil 1 (Überschriften a–j → 5 Texte). Die echte Prüfungsaufgabe ist direkt in der Übung „Leseverstehen“ hinterlegt.",
  ...
  { day: 2, date: "2026-07-02", phase: "Grundlagen",
    ...
    deck: 1, lesen: 7, hoeren: 1, schreiben: 1, sprechen: 1, grammatik: 1, bausteineStart: 6,
    bausteineFocus: "Konnektoren & Wortstellung (weil / obwohl / damit)",
    paper: "P5", paperTask: "telc B1a Probe – Leseverstehen Teil 2 (Artikel „Von Fitmachern und Müdemachern“ + 5 MC). Echter Prüfungstext in der Übung „Leseverstehen“.",
    goal: "Leseverstehen Teil 2 sicher lösen. Deck „Reise“ lernen.",
  ...
  { day: 3, date: "2026-07-03", phase: "Grundlagen",
    ...
    deck: 2, lesen: 8, hoeren: 2, schreiben: 2, sprechen: 3, grammatik: 2, bausteineStart: 12,
    bausteineFocus: "Reflexivpronomen (mich / mir)",
    paper: "P5", paperTask: "telc B1a Probe – Leseverstehen Teil 3 (10 Situationen → 12 Anzeigen, „x“ wenn nichts passt). Echte Aufgabe in der Übung „Leseverstehen“.",
    goal: "Selektives Lesen (Anzeigen) trainieren. Deck „Gesundheit“ lernen.",
  ...
  { day: 4, date: "2026-07-04", phase: "Grundlagen",
    ...
    deck: 3, lesen: 1, hoeren: 3, schreiben: 6, sprechen: 6, grammatik: 3, bausteineStart: 18,
    bausteineFocus: "Wechselpräpositionen (Wo? Dativ / Wohin? Akkusativ)",
    paper: "P1", paperTask: "telc Übungstest 1 – Schriftlicher Ausdruck (Mariannes E-Mail: Ausflüge · Jahreszeit · Kleidung · Vorbereitung) + Mündlich Teil 2 „Gruppenreisen“. Beide echten Aufgaben sind in „Schriftlicher/Mündlicher Ausdruck“ hinterlegt.",
    goal: "Erste vollständige Brief-Antwort + erste Meinungsaufgabe mit echtem Material. Deck „Wohnen & Alltag“.",
  ...
  { day: 5, date: "2026-07-05", phase: "Grundlagen",
    ...
    deck: 4, lesen: 3, hoeren: 0, schreiben: 4, sprechen: 4, grammatik: 4, bausteineStart: 40,
    bausteineFocus: "Sprachbausteine „Brief an Karin“ (echter telc-Lückentext)",
    paper: "P1", paperTask: "telc Übungstest 1 – Sprachbausteine Teil 1 (Brief an Karin) als echte Aufgabe in der Übung „Sprachbausteine“; dazu Leseverstehen Teil 1–3 im PDF auf Zeit.",
    goal: "Erste echte telc-Sprachbausteine lösen. Deck „Umwelt“.",
